              ...
              children: [
                ...
                TextButton(
                  style: TextButton.styleFrom(backgroundColor: Colors.black87),
                    onPressed: ()async{
                     int  number=  await db.insertData("INSERT INTO notes (note, title) VALUES ('${controlle.addnote.text}', '${controlle.addtitle.text}')");
                     if(number>0){
                     Get.offNamed(ManagerRoutes.home);
                     homecontrolle.readdata(homecontrolle.z);
                     }
                    }, child: Text("addnote",style: TextStyle(color: Colors.white),))
              ],
            ))
          ],
        ),
