class ManagerConstant {
  ...
  static const String linkImage = "http://10.0.2.2/users/upload";
  ...
  static const String linkinsert = "$linkServarname/notes/insert.php";
  static const String linkupdate = "$linkServarname/notes/update.php";
  static const String linkview = "$linkServarname/notes/view.php";
}
